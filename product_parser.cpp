...
{
    Product* result = new Book(categoryID(), prodName_, price_, qty_, isbn_, author_);
    return result;
...
Product* ProductClothingParser::makeProduct()
{
    ...
    Product* result = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
    return result;
...
Product* ProductMovieParser::makeProduct()
{
    ...
    Product* result = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
    return result;
